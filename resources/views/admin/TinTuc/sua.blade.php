            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <div class="form-group">
                  <input class="form-control" type="text" name="tieude" value="{{$tintuc->tieude}}" required="true" />
                </div>
              </div>
            ...
            <div class="col-md-8 col-sm-8">
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                <div class="fileinput-new thumbnail">
                  <img src="http://localhost/toicode2/public/upload/tintuc/{{$tintuc->hinh}}" alt="...">
                </div>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-3 col-form-label">
              ...
              <div class="togglebutton">
                <label>
                  <input name='noibat' type="checkbox" 
                  @if($tintuc->NoiBat)
                  checked=""
                  @endif>
